...
/* harmony import */ var _utils_client__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../utils/client */ "./resources/src/utils/client.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_7__.mapGetters)(["currentUser", "currentUserPermissions"])), {}, {
    numberOfBrands: function numberOfBrands() {
      return this.brands.length;
    },
    numberOfCategories: function numberOfCategories() {
      return this.categories.length;
    },
    savedPaymentMethods: function savedPaymentMethods() {
      return this.hasSavedPaymentMethod;
    },
    formNewCard: function formNewCard() {
      return !this.useSavedPaymentMethod;
    ...
    draft_sales_columns: function draft_sales_columns() {
      return [{
        label: this.$t("date"),
        field: "date",
        tdClass: "text-left",
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_7__.mapActions)(["changeSidebarProperties", "changeThemeMode", "logout"])), {}, {
    ...
    selectedPaymentMethod: function selectedPaymentMethod(value) {
      var _this2 = this;
    ...
    // ------------------------ Paginate Products --------------------\\
    paginate_products: function paginate_products() {
      var pageSize = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
      var pageNumber = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
      var ps = pageSize || this.product_perPage;
      var itemsToParse = this.products;
      this.paginated_products = itemsToParse.slice(pageNumber * ps, (pageNumber + 1) * ps);
    },
    ...
    // ------------------------ Paginate Categories --------------------\\
    paginateCategories: function paginateCategories(pageNumber) {
      var pageSize = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      var ps = pageSize || this.category_perPage;
      var itemsToParse = this.categories;
      this.paginated_categories = itemsToParse.slice(pageNumber * ps, (pageNumber + 1) * ps);
    },
    categoryOnPageChanged: function categoryOnPageChanged(page) {
      this.paginateCategories(page - 1, this.category_perPage);
    },
    //--- Submit Validate Create Sale
    submitPos: function submitPos() {
      var _this5 = this;
    ...
    showDraftSales: function showDraftSales() {
      var _this8 = this;
    ...
    //----------------------------------- Remove draft_sales ------------------------------\\
    removeDraftSale: function removeDraftSale(id) {
      var _this10 = this;
      this.$swal({
    ...
    onPageChange: function onPageChange(_ref) {
      ...
      if (this.serverParams.page !== currentPage) {
        ...
        this.getDraftSales(currentPage);
      }
    },
    ...
    getProducts: function getProducts() {
      ...
      nprogress__WEBPACK_IMPORTED_MODULE_0___default().start();
      nprogress__WEBPACK_IMPORTED_MODULE_0___default().set(0.1);
      _utils_client__WEBPACK_IMPORTED_MODULE_6__.posClient.getProducts(this.category_id, this.brand_id, this.sale.warehouse_id, page).then(function (response) {
        _this27.products = response.data.products;
        _this27.product_totalRows = response.data.totalRows;
        _this27.paginate_products();
        // Complete the animation of theprogress bar.
        nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
      })["catch"](function (response) {
        // Complete the animation of theprogress bar.
    ...
    //---------------------------------------Get Elements ------------------------------\\
    init: function init(serverResponse) {
      ...
      this.paginate_Brands(this.brand_perPage, 0);
      this.paginateCategories(this.category_perPage, 0);
  ...
  created: function created() {
    var _this28 = this;
    _utils_client__WEBPACK_IMPORTED_MODULE_6__.posClient.getPosElements().then(this.init)["catch"](function (error) {
    ...
    Fire.$on("pay_now", function () {
      setTimeout(function () {
        ...
        _this28.payment.received_amount = _this28.formatNumber(_this28.GrandTotal, 2);
    ...
    Fire.$on("event_delete_draft_sale", function () {
      _this28.getDraftSales(_this28.serverParams.page);
      // Complete the animation of theprogress bar.
      setTimeout(function () {
        return nprogress__WEBPACK_IMPORTED_MODULE_0___default().done();
      }, 500);
...
var render = function render() {
  ...
  return _c("div", {
    ...
    on: {
      submit: function submit($event) {
        $event.preventDefault();
        return _vm.submitPos.apply(null, arguments);
      }
    }
    ...
    staticClass: "item-title"
  }, [_vm._v(_vm._s(_vm.$t("All_Category")))])])])]), _vm._v(" "), _vm._l(_vm.paginated_categories, function (category) {
    return _c("div", {
      key: category.id,
      staticClass: "card o-hidden bd-highlight m-1",
      "class": {
      ...
      on: {
        click: function click($event) {
          return _vm.getProductsByCategory(category.id);
        }
      }
    }, [_c("img", {
      attrs: {
    ...
    staticClass: "my-0 gull-pagination align-items-center",
    attrs: {
      "total-rows": _vm.numberOfCategories,
    ...
    on: {
      change: _vm.categoryOnPageChanged
    },
    model: {
  ...
  }, [_vm._v(_vm._s(_vm.invoice_pos.symbol) + "\n                                    " + _vm._s(_vm.formatNumber(_vm.invoice_pos.sale.shipping, 2)) + "\n                                ")])]), _vm._v(" "), _c("tr", {
    staticStyle: {
      "margin-top": "10px"
    }
  }, [_c("td", {
  ...
  }, [_vm._v(_vm._s(_vm.invoice_pos.symbol) + " " + _vm._s(_vm.formatNumber(_vm.invoice_pos.sale.paid_amount, 2)) + "\n                                ")])]), _vm._v(" "), _c("tr", {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: _vm.invoice_pos.sale.paid_amount < _vm.invoice_pos.sale.GrandTotal,
      ...
      fn: function fn(_ref6) {
        ...
        return _c("b-form-group", {
          ...
          attrs: {
            ...
            options: _vm.availablePaymentMethods
          },
          on: {
            input: _vm.selectedPaymentMethod
          },
          model: {
  ...
  }, [_vm.submit_showing_credit_card ? _vm._m(0) : _vm._e(), _vm._v(" "), _vm.savedPaymentMethods && !_vm.submit_showing_credit_card ? _c("div", [_c("div", {
    staticClass: "mt-3"
  }, [_c("span", {
    staticClass: "mr-3"
  ...
  }), 0)])]) : _vm._e(), _vm._v(" "), _vm.formNewCard && !_vm.submit_showing_credit_card ? _c("div", [_c("form", {
    attrs: {
      id: "payment-form"
    }
  }, [_c("label", {
    ...
    attrs: {
      mode: "remote",
      columns: _vm.draft_sales_columns,
      totalRows: _vm.numberOfDraftedSales,
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(props) {
        return [props.column.field == "actions" ? _c("span", [_c("router-link", {
          ...
          on: {
            click: function click($event) {
              return _vm.removeDraftSale(props.row.id);
            }
          }
        }, [_c("i", {
...
/* harmony export */ });
var posClient = {
  getProducts: function getProducts(category_id, brand_id, warehouse_id) {
    var page = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 1;
    return axios.get("pos/get_products_pos?page=" + page + "&category_id=" + category_id + "&brand_id=" + brand_id + "&warehouse_id=" + warehouse_id + "&stock=" + 1 + "&product_service=" + 1);
  },
  getPosElements: function getPosElements() {
    return axios.get("pos/data_create_pos");
  }
};
