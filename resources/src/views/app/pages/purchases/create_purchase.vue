            ...
            <b-form @submit.prevent="Submit_Purchase">
                <b-row>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tr v-for="detail in details">
                                                ...
                                                <td
                                                >{{ currentUser.currency }} {{ formatNumber(detail.net_cost, 3) }}
                                                </td>
                                                <td>
                            <span
                                  ...
                                  >+</span>
                                                ...
                                                <td>
                                                    <i v-if="currentUserPermissions && currentUserPermissions.includes('edit_product_purchase')"
                                                       ...
                                                       class="i-Edit text-25 text-success"></i>
                                ...
                                <div class="offset-md-9 col-md-3 mt-4">
                                    <table class="table table-striped table-sm">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span>{{ currentUser.currency }} {{ purchase.tax_net.toFixed(2) }} ({{ formatNumber(purchase.tax_rate, 2) }} %)</span>
                                            </td>
                                        </tr>
                                        <tr>
                    ...
                    ></textarea>
                                ...
                                <b-col md="12">
                                    <b-form-group>
                                        <b-button variant="primary" @click="Submit_Purchase"
            ...
            <b-modal hide-footer size="lg" id="form_Update_Detail" :title="detail.name">
                <b-form @submit.prevent="submitUpdateDetail">
                    <b-row>
                        ...
                        <b-col md="12">
                            <b-form-group>
                                <b-button variant="primary" type="submit" :disabled="Submit_Processing_detail">
                                    {{ $t('submit') }}
                                </b-button>
...
export default {
    ...
    methods: {
        ...
        getProductDetails(product_id, variant_id) {
            const url = "/show_product_data/" + product_id + "/" + variant_id
