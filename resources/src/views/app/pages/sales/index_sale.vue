          ...
          <span v-if="props.column.field == 'actions'">
            <div>
              ...
              >
                ...
                <b-dropdown-item
                  title="Sell Return"
                  v-if="currentUserPermissions.includes('Sale_Returns_add') && props.row.sale_has_return == 'no' && props.row.status == 'completed'"
                ...
                <b-dropdown-item
                  v-if="currentUserPermissions.includes('payment_sales_add') && props.row.status =='completed'"
        ...
        <b-form @submit.prevent="Submit_Payment">
          ...
          <b-row>
            ...
            <b-col lg="4" md="12" sm="12">
                ...
                <b-form-group :label="$t('Received_Amount')">
                  <b-form-input
                    ...
                    :disabled="EditPaymentMode && payment.Reglement == 'credit card'"
                  ></b-form-input>
            ...
            <b-col lg="12" md="12" sm="12">
              <b-card v-show="payment.Reglement == 'credit card' && !EditPaymentMode">
        ...
        <div id="invoice-POS">
          ...
          <div class="info" >
            ...
            <p>
                ...
                <span v-show="pos_settings.show_address">{{$t('Address')}} : {{invoice_pos.setting.CompanyAddress}} <br></span>
