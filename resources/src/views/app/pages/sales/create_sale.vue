                    ...
                    <b-col lg="12" md="12" sm="12">
                        <b-card>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tr v-for="detail  in details">
                                                ...
                                                <td>
                                                    ...
                                                    <span class="badge badge-warning"
                                                          v-else>{{ detail.stock }} {{ detail.unit_sale }}</span>
                                                </td>
                                                <td>
                                                    <div class="quantity">
                                                        <b-input-group>
                          ...
                          >{{ currentUser.currency }} {{ grand_total.toFixed(2) }}</span>
                                ...
                                <!-- PaymentStatus  -->
                                <b-col md="4" v-if="sale.status == 'completed'">
                                ...
                                <!-- Payment choice -->
                                <b-col md="4" v-if="payment.status != 'pending' && sale.status == 'completed'">
                                ...
                                <b-col md="12" class="mt-3"
                                       v-if="payment.status != 'pending' && payment.Reglement == 'credit card' && sale.status == 'completed'">
                              ...
                              <span>
                                ...
                                <b-col lg="4" md="4" sm="12"
                                       v-if="payment.status != 'pending' && sale.status == 'completed'">
...
export default {
    ...
    methods: {
        ...
        Selected_PaymentStatus(value) {
            if (value == "paid") {
                var payment_amount = this.grand_total.toFixed(2);
                    ...
                    for (var k = 0; k < this.units.length; k++) {
                        if (this.units[k].id == this.detail.sale_unit_id) {
                            if (this.units[k].operator == '/') {
                                ...
                                this.details[i].unit_sale = this.units[k].short_name;
        ...
        Calcul_Total() {
            ...
            this.sale.tax_net = parseFloat(
                (total_without_discount * this.sale.tax_rate) / 100
            );
            this.grand_total = parseFloat(
                total_without_discount + this.sale.tax_net + this.sale.shipping
            );
        ...
        getProductDetails(product_id, variant_id) {
            axios.get("/show_product_data/" + product_id + "/" + variant_id).then(response => {
                ...
                this.product.unit_sale = response.data.unit_sale;
