        ...
        <b-card v-if="!isLoading">
            <b-row>
                <b-col md="12" class="mb-5">
                    ...
                    <router-link
                        v-if="quote.status && currentUserPermissions && currentUserPermissions.includes('Quotations_edit')"
                        title="Create"
                                    ...
                                    <tr v-for="detail in details">
                                        <td>
                                            ...
                                            <p v-show="detail.is_imei && detail.imei_number !==null ">
                                                <small>{{ $t('IMEI_SN') }} : {{ detail.imei_number }}</small>
                                            </p>
                                        </td>
                                        <td>{{ detail.code }}</td>
