<template>
    <div class="main-content">
        ...
        <div v-else>
            <vue-good-table mode="remote" :columns="columns" :totalRows="totalRows" :rows="providers"
        ...
        prevLabel: 'prev',
                ...
                <div slot="table-actions" class="mt-2 mb-3">
                    ...
                    <vue-excel-xlsx class="btn btn-sm btn-outline-danger ripple m-1" :data="providers"
                        :columns="columns" :file-name="'providers'" :file-type="'xlsx'" :sheet-name="'providers'">
                        <i class="i-File-Excel"></i> EXCEL
                    </vue-excel-xlsx>
                    <b-button @click="Show_import_providers()" size="sm" variant="info m-1"
                        v-if="currentUserPermissions && currentUserPermissions.includes('Suppliers_import')">
                        <i class="i-Download"></i>
                        {{ $t("Import_Suppliers") }}
                    </b-button>
                    <b-button @click="New_Provider()" size="sm" variant="btn btn-primary btn-icon m-1"
                    ...
                    <span v-if="props.column.field == 'actions'">
                        <div>
                            <b-dropdown id="dropdown-right" variant="link" text="right align"
                                ...
                                <b-dropdown-item @click="showDetails(props.row)">
                ...
                <b-row>
                    ...
                    <b-col md="12">
                        <b-form-group :label="$t('SupplierCode')">
                            <b-form-input label="Code" :placeholder="$t('SearchByCode')"
                                v-model="Filter_Code"></b-form-input>
                        </b-form-group>
                    </b-col>
                    ...
                    <b-col md="12">
                        <b-form-group :label="$t('SupplierName')">
                            <b-form-input label="Name" :placeholder="$t('SearchByName')"
                                v-model="Filter_Name"></b-form-input>
                        </b-form-group>
                    </b-col>
                    <!-- Contact Provider   -->
                    <b-col md="12">
                        <b-form-group :label="$t('SupplierContact')">
                            <b-form-input label="Contact" :placeholder="$t('SearchByContact')"
                                v-model="Filter_Contact"></b-form-input>
                        </b-form-group>
                    </b-col>
                    ...
                    <b-col md="12">
                        <b-form-group :label="$t('Phone')">
                            <b-form-input label="Phone" :placeholder="$t('SearchByPhone')"
                                v-model="Filter_Phone"></b-form-input>
                        </b-form-group>
                    </b-col>
                    ...
                    <b-col md="12">
                        <b-form-group :label="$t('Email')">
                            <b-form-input label="Email" :placeholder="$t('SearchByEmail')"
                                v-model="Filter_Email"></b-form-input>
                        </b-form-group>
                    </b-col>

                    <b-col md="6" sm="12">
                        <b-button @click="Get_Providers(serverParams.page)" variant="primary m-1" size="sm" block>
                            <i class="i-Filter-2"></i>
                            {{ $t("Filter") }}
                        </b-button>
                    </b-col>
        ...
        <!-- Add & Edit Provider -->
        <validation-observer ref="createProvider">
            <b-modal hide-footer size="lg" id="New_Provider" :title="editmode?$t('Edit'):$t('Add')">
                <b-form @submit.prevent="Submit_Provider">
                    <b-row>
                        <!-- Provider Name -->
                        <b-col md="6" sm="12">
                            <validation-provider name="Provider Code"
                                v-slot="validationContext">
                                <b-form-group :label="$t('SupplierCode') + ' ' + '*'">
                                    <b-form-input :state="getValidationState(validationContext)"
                                        aria-describedby="name-feedback" label="name" v-model="provider.code"
                                        :placeholder="$t('SupplierCode')"></b-form-input>
                                        <small>If null, system will generate automatically</small>
                        ...
                        <!-- Provider Name -->
                        <b-col md="6" sm="12">
                            <validation-provider name="Name Provider" :rules="{ required: true}"
                                v-slot="validationContext">
                                <b-form-group :label="$t('SupplierName') + ' ' + '*'">
                                    <b-form-input :state="getValidationState(validationContext)"
                                        aria-describedby="name-feedback" label="name" v-model="provider.name"
                                        :placeholder="$t('SupplierName')"></b-form-input>
                                    <b-form-invalid-feedback id="name-feedback">{{
                                        validationContext.errors[0]
                                        }}
                                    </b-form-invalid-feedback>
                        ...
                        <!-- Provider Contact -->
                        <b-col md="6" sm="12">
                            <validation-provider name="Contact Provider" :rules="{ required: true}"
                                v-slot="validationContext">
                                <b-form-group :label="$t('SupplierContact') + ' ' + '*'">
                                    <b-form-input :state="getValidationState(validationContext)"
                                        aria-describedby="contact-feedback" label="contact" v-model="provider.contact"
                                        :placeholder="$t('SupplierContact')"></b-form-input>
                        ...
                        <b-col md="6" sm="12">
                            <b-form-group :label="$t('Email')">
                                <b-form-input label="email" v-model="provider.email"
                        ...
                        <!-- Provider Phone 1 -->
                        <b-col md="6" sm="12">
                            <b-form-group :label="$t('SupplierPhone1')">
                                <b-form-input label="Phone" v-model="provider.phone_1"
                                    :placeholder="$t('SupplierPhone1')"></b-form-input>
                            </b-form-group>
                        </b-col>

                        <!-- Provider Phone 2 -->
                        <b-col md="6" sm="12">
                            <b-form-group :label="$t('SupplierPhone2')">
                                <b-form-input label="Phone" v-model="provider.phone_2"
                                    :placeholder="$t('SupplierPhone2')"></b-form-input>
                            </b-form-group>
                        </b-col>
                        ...
                        <b-col md="6" sm="12">
                            <b-form-group :label="$t('Country')">
                                <b-form-input label="Country" v-model="provider.country"
                        ...
                        <b-col md="6" sm="12">
                            <b-form-group :label="$t('City')">
                                <b-form-input label="City" v-model="provider.city"
                        ...
                        <b-col md="6" sm="12">
                            <b-form-group :label="$t('Tax_Number')">
                                <b-form-input label="Tax_Number" v-model="provider.tax_number"
                        ...
                        <b-col md="12" sm="12">
                            <b-form-group :label="$t('Address')">
                                <textarea label="Address" class="form-control" rows="4" v-model="provider.address"
                        ...
                        <b-col lg="6" md="12" sm="12">
                            <validation-provider name="Amount" :rules="{ required: true , regex: /^\d*\.?\d*$/}"
                                ...
                                <b-form-group :label="$t('Paying_Amount') + ' ' + '*'">
                                    <b-form-input @keyup="Verified_paidAmount(payment.amount)" label="Amount"
                                    ...
                                    <span class="badge badge-danger">{{ $t('Due') }} : {{
                            ...
                            <validation-provider name="Payment choice" :rules="{ required: true}">
                                <b-form-group slot-scope="{ valid, errors }" :label="$t('Paymentchoice')+ ' ' + '*'">
                                    <v-select :class="{'is-invalid': !!errors.length}"
                                        ...
                                        :reduce="label => label.value" :placeholder="$t('PleaseSelect')" :options="
                          [
        ...
        <validation-observer ref="ref_pay_return_due">
            <b-modal hide-footer size="md" id="modal_Pay_return_due" title="Pay Purchase Return Due">
                    ...
                    <b-row>
                        ...
                        <b-col lg="6" md="12" sm="12">
                            <validation-provider name="Amount" :rules="{ required: true , regex: /^\d*\.?\d*$/}"
                                v-slot="validationContext">
                                <b-form-group :label="$t('Paying_Amount') + ' ' + '*'">
                                    <b-form-input @keyup="Verified_return_paidAmount(payment_return.amount)"
                                        label="Amount" :placeholder="$t('Paying_Amount')"
                            ...
                            <validation-provider name="Payment choice" :rules="{ required: true}">
                                <b-form-group slot-scope="{ valid, errors }" :label="$t('Paymentchoice')+ ' ' + '*'">
                                    <v-select :class="{'is-invalid': !!errors.length}"
                                        ...
                                        v-model="payment_return.Reglement" :reduce="label => label.value"
                        ...
                        <b-col lg="6" md="6" sm="12">
                            <validation-provider name="Account">
                                <b-form-group slot-scope="{ valid, errors }" :label="$t('Account')">
                                    <v-select :class="{'is-invalid': !!errors.length}"
                                        :state="errors[0] ? false : (valid ? true : null)"
                                        v-model="payment_return.account_id" :reduce="label => label.value"
                        ...
                        <b-col lg="12" md="12" sm="12" class="mt-3">
                            <b-form-group :label="$t('Please_provide_any_details')">
                                <b-form-textarea id="textarea" v-model="payment_return.notes" rows="3"
                                    max-rows="6"></b-form-textarea>
                            </b-form-group>
                        </b-col>

                        <b-col md="12" class="mt-3">
                            <b-button variant="primary" type="submit" :disabled="payment_return_Processing"><i
                                    class="i-Yes me-2 font-weight-bold"></i> {{ $t('submit') }}
                            </b-button>
                ...
                <div style="max-width:400px;margin:0px auto">
                    <div class="info">
                        ...
                        <p>
                            ...
                            <span>{{ $t('Address') }} : {{ company_info.CompanyAddress }} <br></span>
                    ...
                    <table class="change mt-3" style=" font-size: 10px;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="text-align: center;" colspan="2">{{ formatNumber(payment.amount, 2) }}
                                </td>
                                <td style="text-align: right;" colspan="1">{{ formatNumber(payment.due - payment.amount,
                                    2) }}
                                </td>
                            </tr>
                        </tbody>
                    ...
                    <table class="change mt-3" style=" font-size: 10px;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="text-align: center;" colspan="2">{{ formatNumber(payment_return.amount, 2) }}
                                </td>
                                <td style="text-align: right;" colspan="1">{{ formatNumber(payment_return.return_Due -
                                    payment_return.amount, 2) }}
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <b-col lg="12" md="12" sm="12" class="mt-3">
                    <table class="table table-striped table-md">
                        <tbody>
                            ...
                            <tr>
                                <!-- Provider Name -->
                                <td>{{ $t('SupplierContact') }}</td>
                                <th>{{ provider.contact }}</th>
                            </tr>
                            <tr>
                                <!-- Provider Phone -->
                                <td>{{ $t('Phone_1') }}</td>
                                <th>{{ provider.phone_1 }}</th>
                            </tr>
                            <tr>
                                <!-- Provider Phone -->
                                <td>{{ $t('Phone_2') }}</td>
                                <th>{{ provider.phone_2 }}</th>
                            </tr>
                            <tr>
                                <!-- Provider Email -->
                                <td>{{ $t('Email') }}</td>
        ...
        <b-modal ok-only ok-title="Cancel" size="md" id="importProviders" :title="$t('Import_Suppliers')">
            <b-form @submit.prevent="Submit_import" enctype="multipart/form-data">
                <b-row>
                    ...
                    <b-col md="6" sm="12">
                        <b-button :href="'/import/exemples/import_providers.csv'" variant="info" size="sm" block>{{
                            $t("Download_example") }}
                        </b-button>
                    </b-col>
...
export default {
    ...
    methods: {
        ...
        Submit_Provider() {
            this.$refs.createProvider.validate().then(success => {
                if (!success) {
                    this.makeToast(
                        "danger",
