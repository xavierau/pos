<template>
    <div class="main-content">
        ...
        <validation-observer ref="Create_adjustment" v-if="!isLoading">
            <b-form @submit.prevent="submitAdjustment">
                <b-row>
                        ...
                        <b-card>
                            ...
                            >{{ detail.current }} {{ detail.unit }}</span>
                                  ...
                                  >+</span>
                                                ...
                                                <td>
                                                    <a
                                                        @click="removeProduct(detail.detail_id)"
                    ...
                    ></textarea>
                                ...
                                <b-col md="12">
                                    <b-form-group>
                                        <b-button variant="primary" :disabled="SubmitProcessing"
                                                  @click="submitAdjustment"><i class="i-Yes me-2 font-weight-bold"></i>
                                            {{ $t('submit') }}
                                        </b-button>
            ...
            if (this.adjustment.warehouse_id != "" && this.adjustment.warehouse_id != null) {
                this.timer = setTimeout(() => {
                    const product_filter = this.products.filter(
                        product => product.code === this.search_input
                        // || product.barcode.includes(this.search_input)
                    );
                    console.log('executing search', product_filter, this.search_input)
