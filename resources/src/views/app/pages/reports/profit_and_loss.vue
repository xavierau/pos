          ...
          <b-row>
            ...
            <b-col md="4" sm="12">
              <div class="card card-icon text-center mb-30">
                <div class="card-body">
                  <i class="i-Data-Upload"></i>
                  <p class="text-muted mt-2 mb-2">{{$t('PaymentsReceived')}}</p>
                  <p
                    class="text-primary text-24 line-height-1 m-0"
                ...
                <div class="card-footer">
                  <p>
                    ...
                    <span
                      class="bold"
                    >{{currentUser.currency}} {{infos.Payment_sales}}</span>
                    {{$t('PaymentsSales')}}
                    +
                    <span
                      class="bold"
            ...
            <b-col md="4" sm="12">
              <div class="card card-icon text-center mb-30">
                <div class="card-body">
                  <i class="i-Data-Upload"></i>
                  <p class="text-muted mt-2 mb-2">{{$t('PaymentsSent')}}</p>
                  <p
                    class="text-primary text-24 line-height-1 m-0"
                ...
                <div class="card-footer">
                  <p>
                    ...
                    <span
                      class="bold"
                    >{{currentUser.currency}} {{infos.Payment_purchases}}</span>
                    {{$t('PaymentsPurchases')}}
                    +
                    <span
                      class="bold"
            ...
            <b-col md="4" sm="12">
              <div class="card card-icon text-center mb-30">
                <div class="card-body">
                  <i class="i-Data-Upload"></i>
                  <p class="text-muted mt-2 mb-2">{{$t('PaymentsNet')}}</p>
                  <p
                    class="text-primary text-24 line-height-1 m-0"
                  >{{currentUser.currency}} {{infos.Payment_net}}</p>
                </div>
                <div class="card-footer">
                  <p>
                    (
