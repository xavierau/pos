...
export default {
    ...
    We_cant_find_a_user_with_the_email_address: 'Мы не можем найти пользователя с таким адресом электронной почты',
    We_have_emailed_your_password_reset_link: 'Мы отправили вам ссылку для сброса пароля по электронной почте',
    Please_fill_the_Email_Address: 'Пожалуйста, заполните адрес электронной почты',
    ...
    Del: 'удалять',
    SuppliersPaymentsReport: 'Отчет о платежах поставщикам',
    ...
    Update: {
        ...
        TitleWarehouse: 'Склад успешно обновлен',
    ...
    Create: {
        ...
        TitleWarehouse: 'Склад успешно создан',
    ...
    PaymentsNet: 'Чистые платежи',
    PaymentsSent: 'Отправленные платежи',
    PaymentsReceived: 'Платежи получены',
    Recieved: 'Получила',
    Sent: 'Отправлено',
    ProductQuantityAlerts: 'Оповещения о количестве товаров',
    ProductCode: 'Код',
    ...
    CustomerPaymentsReport: 'Отчет о платежах клиентов',
    ...
    SupplierPaymentsReport: 'Отчет о платежах поставщикам',
    Name: 'название',
    Code: 'Код',
    ...
    StockAdjustment: 'Регулировка запаса',
