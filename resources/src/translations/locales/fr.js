...
export default {
    ...
    Show_Address:'Afficher l\'Address',
    ...
    Payment_Gateway:'Passerelle de Payment',
    SMS_Configuration:'Configuration SMS',
    Gateway:'Passerelle de Payment',
    Choose_Gateway:'Choisissez la passerelle de Payment',
    ...
    Download_example:'Télécharger l\'exemple',
    ...
    Reports_payments_Purchase_Return:'Rapports sur les Payments de retour d\'achat',
    Reports_payments_Sale_Return:'Rapports sur les Payments de retour de vente',
    payments_Sales_Return:'Payments retour de vente',
    payments_Purchases_Return:'Payments retour d\'achats',
    ...
    Choose_Status: 'Choisissez le status',
    ...
    We_cant_find_a_user_with_the_email_address: 'Nous ne pouvons pas trouver un utilisateur avec cette Address e-mail',
    We_have_emailed_your_password_reset_link: 'Nous avons envoyé votre lien de réinitialisation de mot de passe par e-mail',
    Please_fill_the_Email_Address: 'Veuillez remplir l\'Address e-mail',
    ...
    View_all: 'Voir tout',
    Payment_Sent_Received: 'Payment envoyé et reçu',
    Filter: 'Filtre',
    ...
    Del: 'Effacer',
    SuppliersPaymentsReport: 'Fournisseurs Rapport Payments',
    ...
    Reports_payments_Sales: 'Rapports des Payments des ventes',
    Reports_payments_Purchases: 'Rapports des achats de Payments',
    Reports_payments_Return_Customers: 'Rapports de Payments Clients de retour',
    Reports_payments_Return_Suppliers: 'Rapports des Payments Retour Fournisseurs',
    ...
    Reports: 'Rapports',
    PaymentsReport: 'Payments Rapports',
    PaymentsPurchases: 'Payments Achats',
    PaymentsSales: 'Payments Ventes',
    PaymentsReturns: 'Payments Retours',
    ...
    PaymentStatus: 'status de Payment',
    Customer: 'Client',
    ...
    ShowPayment: 'Afficher les Payments',
    AddPayment: 'Ajouter un Payment',
    EditPayment: 'Modifier le Payment',
    EmailSale: 'Envoyer la vente par e-mail',
    DeleteSale: 'Supprimer la vente',
    Amount: 'Montant',
    ModePayment: 'Mode de Payment',
    Paymentchoice: 'Mode de règlement',
    Note: 'Remarque',
    PaymentComplete: 'Payment compléte!',
    ...
    CompanyAddress: 'Address de la société',
    Code: 'Code',
    image: 'Image',
    ...
    PleaseSelectstatus: 'Veuillez sélectionner le status',
    PayeBy: 'Payé avec',
    ...
    ProblemPayment: 'Il y a eu un problème de Payment. Veuillez réessayer.',
    ...
    Delete: {
        ...
        PaymentDeleted: 'Cette Payment a été supprimée.',
    ...
    Update: {
        ...
        TitlePayment: 'Payment mis à jour  avec succès',
        ...
        TitleWarehouse: 'Magasin mis à jour avec succès',
    ...
    Create: {
        ...
        TitlePayment: 'Payment créé  avec succès',
        ...
        TitleWarehouse: 'Magasin créé avec succès',
    ...
    Return: 'Retour',
    Purchase: 'Achat',
    PurchaseInvoice: 'Payment des achats',
    PurchasesInvoicesData: 'Données Payment d\'achat',
    SalesInvoices: 'Payment des ventes',
    SalesInvoicesData: 'Données Payment de vente',
    TotalSales: 'Ventes totales',
    TotalPurchases: 'Total des achats',
    TotalReturns: 'Retours totaux',
    PaymentsNet: 'Payment net',
    PaymentsSent: 'Payments envoyés',
    PaymentsReceived: 'Payments reçus',
    Recieved: 'Reçus',
    Sent: 'Envoyés',
    ...
    StockAdjustment: 'Ajustement des stocks',
    ...
    ReturnDashboard: 'Retour au tableau de bord',
     ...
     Enter_email_address:'Entrer l\'Address e-mail',
     ...
     Choose_Family_status:'Choisissez le status familial',
     ...
     Enter_Address:'Entrer l\'Address',
    ...
    Delivered:'Livré',
    Cancelled:'Annulé',
    Shipping_status:'status d\'envoi',
    ...
    Pay_Due:'payer dû',
    Paying_amount_is_greater_than_Total_Due:'Le montant du Payment est supérieur au total dû',
