...
export default {
    ...
    Download_example:'Tải xuống ví dụ',
    ...
    We_cant_find_a_user_with_the_email_address: 'Chúng tôi không thể tìm thấy người dùng có địa chỉ email đó',
    We_have_emailed_your_password_reset_link: 'Chúng tôi đã gửi qua e-mail liên kết đặt lại mật khẩu của bạn',
    Please_fill_the_Email_Address: 'Vui lòng điền vào Địa chỉ Email',
    ...
    Del: 'Xóa bỏ',
    SuppliersPaymentsReport: 'Báo cáo thanh toán cho nhà cung cấp',
    ...
    Update: {
        ...
        TitleWarehouse: 'Đã cập nhật kho hàng thành công',
    ...
    Create: {
        ...
        TitleWarehouse: 'Đã tạo kho thành công',
    ...
    PaymentsNet: 'Thanh toán ròng',
    PaymentsSent: 'Thanh toán đã gửi',
    PaymentsReceived: 'Đã nhận thanh toán',
    Recieved: 'Nhận',
    Sent: 'Gởi',
    ProductQuantityAlerts: 'Cảnh báo số lượng sản phẩm',
    ProductCode: 'Mã',
    ...
    CustomerPaymentsReport: 'Báo cáo thanh toán của khách hàng',
    ...
    SupplierPaymentsReport: 'Báo cáo thanh toán của nhà cung cấp',
    Name: 'Tên',
    Code: 'Mã',
    ...
    StockAdjustment: 'Điều chỉnh chứng khoán',
