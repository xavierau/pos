...
export default {
    ...
    We_cant_find_a_user_with_the_email_address: '我们找不到使用该电子邮件地址的用户',
    We_have_emailed_your_password_reset_link: '我们已经通过电子邮件发送了您的密码重置链接',
    Please_fill_the_Email_Address: '请填写电子邮件地址',
    ...
    Quote_Info: '报价信息',
    Del: '删除',
    SuppliersPaymentsReport: '供应商付款报告',
    Purchase_Info: '购买信息',
    Supplier_Info: '供应商信息',
    Return_Info: '退货信息',
