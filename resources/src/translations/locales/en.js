...
export default {
    ...
    promotional_start_date: 'Promotional Start Date',
    promotional_end_date: 'Promotional End Date',
    ...
    Enter_Promotional_Price: 'Enter Product Promotinal Price',
    ...
    We_cant_find_a_user_with_the_email_address: 'We can\'t find a user with that email addres',
    We_have_emailed_your_password_reset_link: 'We have e-mailed your password reset link',
    Please_fill_the_Email_Address: 'Please fill the Email Address',
    ...
    Del: 'Delete',
    SuppliersPaymentsReport: 'Suppliers Payments Report',
    ...
    SupplierPhone1: 'Phone 1',
    SupplierPhone2: 'Phone 2',
    ...
    Update: {
        ...
        TitleWarehouse: 'Warhouse Updated in successfully',
    ...
    Create: {
        ...
        TitleWarehouse: 'Warehouse Created in successfully',
    ...
    CustomerPaymentsReport: 'Customer Payments Report',
    ...
    SupplierPaymentsReport: 'Supplier Payments Report',
    Name: 'Name',
    Code: 'Code',
    ...
    "Promotions:IndexPageTitle": "Promotions",
    "Promotions:ErrorMessages:LoadPromotions": "Error loading promotions",
    "Promotions:CreatePageTitle": "Create Promotion",
    "Promotions:Type": "Promotion Types",
    "Promotions:ChooseType": "Select Promotion Type",
    "Promotion:XProduct": "X Product",
    "Promotion:XQty": "X Quantity",
    "Promotion:YProduct": "Y Product",
    "Promotion:YQty": "Y Quantity",
};
