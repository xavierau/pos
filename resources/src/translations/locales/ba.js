...
export default {
    ...
    Download_example:'উদাহরণ ডাউনলোড করুন',
    ...
    We_cant_find_a_user_with_the_email_address: 'আমরা সেই ইমেল ঠিকানা সহ একজন ব্যবহারকারী খুঁজে পাচ্ছি না',
    We_have_emailed_your_password_reset_link: 'আমরা আপনার পাসওয়ার্ড রিসেট লিঙ্ক ই-মেইল করেছি',
    Please_fill_the_Email_Address: 'অনুগ্রহ করে ইমেল ঠিকানা পূরণ করুন',
    ...
    Del: 'মুছে ফেলা',
    SuppliersPaymentsReport: 'সরবরাহকারী পেমেন্ট রিপোর্ট',
    ...
    ModePayment: 'দ্বারা পরিশোধ করা হয়',
    ...
    PleaseSelectstatus: 'দয়া করে স্থিতি নির্বাচন করুন৷',
    ...
    Update: {
        ...
        TitleWarehouse: 'সফলভাবে আপডেট হয়েছে',
    ...
    Create: {
        ...
        TitleWarehouse: 'সফলভাবে তৈরি করা হয়েছে',
    ...
    PaymentsNet: 'পেমেন্ট নেট',
    PaymentsSent: 'পেমেন্ট পাঠানো হয়েছে',
    PaymentsReceived: 'পেমেন্ট পেয়েছি',
    Recieved: 'গৃহীত',
    Sent: 'পাঠানো হয়েছে',
    ProductQuantityAlerts: 'পণ্য পরিমাণ সতর্কতা',
    ProductCode: 'কোড',
    ...
    CustomerPaymentsReport: 'গ্রাহক পেমেন্ট রিপোর্ট',
    ...
    SupplierPaymentsReport: 'সরবরাহকারী পেমেন্ট রিপোর্ট',
    Name: 'নাম',
    Code: 'কোড',
