...
export default {
    ...
    We_cant_find_a_user_with_the_email_address: 'Kami tidak dapat menemukan pengguna dengan alamat email itu',
    We_have_emailed_your_password_reset_link: 'Kami telah mengirimkan email tautan pengaturan ulang kata sandi Anda',
    Please_fill_the_Email_Address: 'Silahkan isi Alamat Email',
    ...
    Del: 'Menghapus',
    SuppliersPaymentsReport: 'Laporan Pembayaran Pemasok',
    ...
    Update: {
        ...
        TitleWarehouse: 'Gudang berhasil diperbarui',
    ...
    Create: {
        ...
        TitleWarehouse: 'Gudang Dibuat dengan sukses',
    ...
    CustomerPaymentsReport: 'Laporan Pembayaran Pelanggan',
    ...
    SupplierPaymentsReport: 'Laporan Pembayaran Pemasok',
    Name: 'Nama',
    Code: 'Kode',
