...
export default {
    ...
    Download_example:'Örneği indirin',
    ...
    We_cant_find_a_user_with_the_email_address: 'Bu e-posta adresine sahip bir kullanıcı bulamıyoruz',
    We_have_emailed_your_password_reset_link: 'şifre sıfırlama bağlantınızı e-postayla gönderdim',
    Please_fill_the_Email_Address: 'Lütfen E-posta Adresini doldurun',
    ...
    Del: 'Sil',
    SuppliersPaymentsReport: 'Tedarikçi Ödemeleri Raporu',
    ...
    PleaseSelectstatus: 'Lütfen Durum Seçiniz',
    PayeBy: 'Ödeyen',
    ...
    Update: {
        ...
        TitleWarehouse: 'Depo başarıyla güncellendi',
    ...
    Create: {
        ...
        TitleWarehouse: 'Depo Başarıyla Oluşturuldu',
    ...
    PaymentsNet: 'Net Ödemeler',
    PaymentsSent: 'Gönderilen Ödemeler',
    PaymentsReceived: 'Ödemeler alındı',
    Recieved: 'Alınan',
    Sent: 'Gönderildi',
    ProductQuantityAlerts: 'Ürün Miktarı Uyarıları',
    ProductCode: 'Kod',
    ...
    CustomerPaymentsReport: 'Müşteri Ödemeleri Raporu',
    ...
    SupplierPaymentsReport: 'Tedarikçi Ödemeleri Raporu',
    Name: 'İsim',
    Code: 'Kod',
