...
export default {
    ...
    We_cant_find_a_user_with_the_email_address: 'لا يمكننا العثور على مستخدم بعنوان البريد الإلكتروني هذا',
    We_have_emailed_your_password_reset_link: 'لقد أرسلنا رابط إعادة تعيين كلمة المرور بالبريد الإلكتروني',
    Please_fill_the_Email_Address: 'يرجى ملء عنوان البريد الإلكتروني',
    ...
    Del: 'حذف',
    SuppliersPaymentsReport: 'تقرير مدفوعات الموردين',
    ...
    PleaseSelectstatus: 'يرجى تحديد الحالة',
    ...
    Update: {
        ...
        TitleWarehouse: 'تم تحديث المخزن بنجاح',
    ...
    Create: {
        ...
        TitleWarehouse: 'تم إنشاء المخزن بنجاح',
